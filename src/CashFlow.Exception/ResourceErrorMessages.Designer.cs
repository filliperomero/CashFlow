...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Expenses cannot have a future date.
        /// </summary>
        public static string EXPENSE_CANNOT_HAVE_FUTURE_DATE {
            get {
                return ResourceManager.GetString("EXPENSE_CANNOT_HAVE_FUTURE_DATE", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Your password must be at least 8 characters long, containing at least one uppercase letter, one lowercase letter, a number and a special character (for example !, ?, *).
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Password provided is different from the current password.
        /// </summary>
